...
class CandidateController extends Controller
{
    ...
    public function edit_password_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Mật khẩu được cập nhật thành công.');
    }
    ...
    public function education_store(Request $request)
    {
        ...
        return redirect()->route('candidate_education')->with('success', 'Giáo dục được thêm thành công.');
    }
    ...
    public function education_update(Request $request, $id)
    {
        ...
        return redirect()->route('candidate_education')->with('success', 'Giáo dục được cập nhật thành công.');
    }

    public function education_delete($id)
    {
        CandidateEducation::where('id',$id)->delete();
        return redirect()->route('candidate_education')->with('success', 'Đã xóa giáo dục thành công.');
    }
    ...
    public function skill_store(Request $request)
    {
        ...
        return redirect()->route('candidate_skill')->with('success', 'Kỹ năng được thêm thành công.');
    }
    ...
    public function skill_update(Request $request, $id)
    {
        ...
        return redirect()->route('candidate_skill')->with('success', 'Kỹ năng được cập nhật thành công.');
    }

    public function skill_delete($id)
    {
        CandidateSkill::where('id',$id)->delete();
        return redirect()->route('candidate_skill')->with('success', 'Kỹ năng đã được xóa thành công.');
    }
