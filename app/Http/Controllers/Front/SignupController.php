...
class SignupController extends Controller
{
    ...
    public function candidate_signup_submit(Request $request)
    {
        ...
        return redirect()->route('login')->with('success', 'Thông tin xác nhận đăng ký được gửi đến địa chỉ email của bạn. Bạn phải kiểm tra và nhấp vào liên kết xác nhận để xác thực đăng ký của mình.');
    ...
    public function candidate_signup_verify($token,$email)
    {
        ...
        return redirect()->route('login')->with('success', 'Email của bạn được xác minh thành công. Bây giờ bạn có thể đăng nhập vào hệ thống với tư cách là ứng viên.');
