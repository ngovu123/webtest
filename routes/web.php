...
Route::middleware(['company:company'])->group(function() {
    ...
    Route::post('/company/vnpay/payment', [CompanyController::class, 'vnpay'])->name('company_vnpay');
    Route::get('/company/vnpay/success', [CompanyController::class, 'vnpay_success'])->name('company_vnpay_success');
