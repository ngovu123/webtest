                                    ...
                                    <ul class="cv-experience-list " >
                                        ...
                                        <li>
                                            <div class="mb-5 row">
                                                ...
                                                <div class="col-sm-7 col-md-7 col-xl-5">
                                                    <input type="text" class="form-control" value="{{old('company.0')}}" name="company[]" >

                                                    @if($errors->has('company.0'))
                                                        <span class="text text-danger">{{$errors->first('company.0')}}</span>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="mb-5 row">
                                                ...
                                                <div class="col-sm-3 col-md-3 ">
                                                    <input type="date" class="form-control" value="{{old('start_date.0')}}" name="start_date[]" >

                                                    @if($errors->has('start_date.0'))
                                                        <span class="text text-danger">{{$errors->first('start_date.0')}}</span>
                                                    @endif
                                                </div>
                                                <div class="col-sm-3 col-md-3 ">
                                                    <input type="date" class="form-control" value="{{old('end_date.0')}}" name="end_date[]" >

                                                    @if($errors->has('end_date.0'))
                                                        <span class="text text-danger">{{$errors->first('end_date.0')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <ul class="cv-education-list">
                                        ...
                                        <li>
                                            <div class="mb-5 row">
                                                ...
                                                <div class="col-sm-7 col-md-7 col-xl-5">
                                                    <input type="text" class="form-control" value="{{old('institute.0')}}" name="institute[]" >

                                                    @if($errors->has('institute.0'))
                                                        <span class="text text-danger">{{$errors->first('institute.0')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="mb-5 row">
                                                ...
                                                <div class="col-sm-3 col-md-3 ">
                                                    <input type="date" class="form-control" value="{{old('passing_year.0')}}" name="passing_year[]" >

                                                    @if($errors->has('passing_year.0'))
                                                        <span class="text text-danger">{{$errors->first('passing_year.0')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="mb-5 row">
