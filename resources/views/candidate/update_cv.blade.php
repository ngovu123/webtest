                                        ...
                                        @foreach($experiences as $key=>$item)
                                            <li>
                                                ...
                                                <div class="mb-5 row">
                                                    ...
                                                    <div class="col-sm-7 col-md-7 col-xl-5">
                                                        <input type="text" class="form-control" value="{{$item->company}}" name="company[]" >

                                                        @if($errors->has('company.'.$key))
                                                            <span class="text text-danger">{{$errors->first('company.'.$key)}}</span>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="mb-5 row">
                                                    ...
                                                    <div class="col-sm-3 col-md-3 ">
                                                        <input type="date" class="form-control" value="{{$item->start_date}}" name="start_date[]" >

                                                        @if($errors->has('start_date.'.$key))
                                                            <span class="text text-danger">{{$errors->first('start_date.'.$key)}}</span>
                                                        @endif
                                                    </div>
                                                    <div class="col-sm-3 col-md-3 ">
                                                        <input type="date" class="form-control" value="{{$item->end_date}}" name="end_date[]" >

                                                        @if($errors->has('end_date.'.$key))
                                                            <span class="text text-danger">{{$errors->first('end_date.'.$key)}}</span>
                                                        @endif
                                                    </div>
                                                </div>
