                ...
                <div class="job-filter">
                    ...
                    <div class="widget">
                        ...
                        <select name="location" class="form-control select2">
                            <option value="">Vị trí công ty</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="search-result-header">
                                    <i class="fas fa-search"></i> Kết quả tìm kiếm cho danh sách Nhà tuyển dụng
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="item d-flex justify-content-start">
                                    ...
                                    <div class="text">
                                        <h3><a href="{{ route('company',$item->id) }}">{{ $item->id }}, {{ $item->company_name }}</a></h3>
                                        ...
                                        <div class="open-position">
                                            <span class="badge bg-primary">{{ $item->r_job_count }} Vị trí</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
