            ...
            <div class="col-md-12 job job-single">
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        ...
                        <div class="apply">
                            @if(date('Y-m-d') <= $job_single->deadline)
                            <a href="{{ route('candidate_apply',$job_single->id) }}" class="btn btn-primary">Apply ngay</a>
                            <a href="{{ route('candidate_bookmark_add',$job_single->id) }}" class="btn btn-primary save-job">Lưu</a>
                            @endif
                        </div>
                        @endif
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Mô tả công việc</h2>
                    <p>{!! $job_single->description !!}</p>
                </div>
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Trách nhiệm công việc</h2>
                    {!! $job_single->responsibility !!}
                </div>
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Kỹ năng và sở trường</h2>
                    {!! $job_single->skill !!}
                </div>

                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Trình độ học vấn</h2>
                    {!! $job_single->education !!}
                </div>

                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Phúc lợi </h2>
                    {!! $job_single->benefit !!}
                </div>
                ...
                <div class="left-item">
                    <div class="apply">
                        <a href="apply.html" class="btn btn-primary">Apply Ngay</a>
                    </div>
                </div>
                @endif

                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Công việc liên quan</h2>
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="right-item">
                    <h2><i class="fas fa-file-invoice"></i> Nếu bạn chưa yên tâm. Hãy để lại thông tin liên hệ tại mẫu Form này:</h2>
                    <div class="enquery-form">
                        <form action="{{ route('job_enquery_send_email') }}" method="post">
                            ...
                            <div class="mb-3">
                                <input type="text" name="visitor_name" class="form-control" placeholder="Họ và tên">
                            </div>
                            <div class="mb-3">
                                <input type="email" name="visitor_email" class="form-control" placeholder="Địa chỉ Email">
                            </div>
                            <div class="mb-3">
                                <input type="text" name="visitor_phone" class="form-control" placeholder="Số điện thoại">
                            </div>
                            <div class="mb-3">
                                <textarea name="visitor_message" class="form-control h-150" rows="3" placeholder="Lời nhắn"></textarea>
                            </div>
                            <div class="mb-3">
                ...
                <div class="right-item">
                    <h2><i class="fas fa-file-invoice"></i> Ví trí Công ty</h2>
