    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                @if($company_photos!="")
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Hình ảnh</h2>
                    <div class="photo-all">
                        <div class="row">
                ...
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Vị trí</h2>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="right-item">
                    <h2><i class="fas fa-file-invoice"></i> Tổng quan công ty</h2>
                    <div class="summary">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tr>
                ...
                <div class="right-item">
                    <h2><i class="fas fa-file-invoice"></i> Bản đồ địa điểm</h2>
                ...
                <div class="right-item">
                    <h2><i class="fas fa-file-invoice"></i> Liên hệ với Nhà tuyển dụng</h2>
